 ...
 * @version $Id: 2021/12/12 上午12:18 WeChatMiniException.php $
 */
class WeChatMiniException extends \RuntimeException
{
    private $errors = [
        -1      => '系统繁忙，此时请开发者稍候再试',
    ...
    public function __construct($message = "", $code = 0, Throwable $previous = null)
    {
        ...
        parent::__construct($code ? "{$message}[{$code}]" : $message, $code, $previous);
    }
}